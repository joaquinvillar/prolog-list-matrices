...
test(solverDiagonalIReverso) :- 
    ...
    P=[o,t,a],
    buscarDiagonalIReverso(M,P,4,7,6,5).




test(solverDiagonalIDirecto) :- 
    M= [[a,c,a,v,d,c,k,c],
        [o,y,w,l,o,b,a,e], 
        [v,s,m,n,z,n,k,r],
        [a,o,e,p,i,p,o,d],
    ...
    P=[o,j,e,n,o,c],
    buscarDiagonalIDirecto(M,P,6,1,1,6).


test(solverHorizontal) :- 
    M= [[a,c,a,v,d,c,k,c],
        [o,y,w,l,o,b,a,e], 
        [v,s,m,n,z,n,k,r],
        [a,o,e,p,i,p,o,d],
    ...
    P=[p,i,p,o],
    buscarHorizontalIzqADer(M,P,4,4,4,7).

test(solverHorizontalR) :- 
    M= [[a,c,a,v,d,c,k,c],
        [o,y,w,l,o,b,a,e], 
        [v,s,m,n,z,n,k,r],
        [a,o,e,p,i,p,o,d],
    ...
    P=[v,a,c,a],
    buscarHorizontalDerAIzq(M,P,1,4,1,1).

test(solverVerticalArribaAbajo) :- 
    M= [[a,c,a,v,d,c,k,c],
        [o,y,w,l,o,b,a,e], 
        [v,s,m,n,z,n,k,r],
        [a,o,e,p,i,p,o,d],
    ...
    P=[c,e,r,d,o],
    buscarVerticalArribaAbajo(M,P,1,8,5,8).


test(solverVerticalAbajoArriba) :- 
    M= [[a,c,a,v,d,c,k,c],
        [o,y,w,l,o,b,a,e], 
        [v,s,m,n,z,n,k,r],
        [a,o,e,p,i,p,o,d],
    ...
    P=[p,a,v,o],
    buscarVerticalAbajoArriba(M,P,5,1,2,1).

test(solverDiagonalDDirecto) :- 
    M= [[a,c,a,v,d,c,k,c],
        [o,y,w,l,o,b,a,e], 
        [v,s,m,n,z,n,k,r],
        [a,o,e,p,i,p,o,d],
    ...
    P=[s,e,l,a],
    buscarDiagonalDDirecto(M,P,3,2,6,5).

test(solverDiagonalDReverso) :- 
    M= [[a,c,a,v,d,c,k,c],
        [o,y,w,l,o,b,a,e], 
        [v,s,m,n,z,n,k,r],
        [a,o,e,p,i,p,o,d],
    ...
    P=[l,e,s],
    buscarDiagonalDReverso(M,P,5,4,3,2).
